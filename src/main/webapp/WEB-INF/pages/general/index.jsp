    ...
    <jsp:body>
        ...
        <div class="col-lg-3">
            <div class="btn-group-vertical w-100" role="group">
                <a class="btn btn-outline-primary" href="${pageContext.request.contextPath}/fc/roofFlat-page">Carport
                    med fladt tag</a>
                <a class="btn btn-outline-primary" href="${pageContext.request.contextPath}/fc/roofSloped-page">Carport
                    med rejsning</a>
